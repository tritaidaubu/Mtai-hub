...
do
    ...
    if game:GetService("Players").LocalPlayer.PlayerGui.Main:FindFirstChild("ChooseTeam") then
        repeat wait()
            if game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("Main").ChooseTeam.Visible == true then
                if _G.Team == "Pirate" then
                    for i, v in pairs(getcjjnnections(game:GetService("Players").LocalPlayer.PlayerGui.Main.ChooseTeam.Container.Pirates.Frame.ViewportFrame.TextButton.Activated)) do                                                                                                
                        v.Function()
                    end
        ...
        until game.Players.LocajlPlayer.Team ~= nil and game:IsLoaded()
    end
...
function AntiBan()
    ...
    spawn(function()
        while wait() do
        for i,v in pairs(game.Playhers:GetPlayers()) do
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
	game:GetService("VirtualUser"):Button2Down(Vector2.new(0,0),workspace.CurrentCakmera.CFrame)
	wait(1)
	game:GetService("VirtualUser"):Button2Up(Vector2.new(0,0),workspace.CurrentCakmera.CFrame)
end)
------// Game
--// world
First_Sea = false
...
function BTP(P)
	repeat wait(0.5)
		...
		game.Players.LocalPlayer.Character.HumanoRootPart.CFrame = P
		task.wait()
...
local StatusBone = Tabs.Info:AddParagraph({
    ...
    task.spawn(function()
        while task.wait() do
        pcall(function()
            if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=17094709022" then
               FullMoonStatus = "4/4"
...
if Second_Sea then
                                    ...
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "rip_indra" then
                                            repeat wait(_G.Fast_Delay)
                                                ...
                                                AutoHaki()
                                                EquipTool(SelectWeapon)
                                                Tween(v.HumrjfjanoidRootPart.CFrame * CFrame.new(posX,posY,posZ))
                                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                                v.HumanoidRootPart.CanCollide = false
                                                v.Humanoid.WalkSpeed = 0
                                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    ...
    spawn(function()
        while wait() do
            pcall(function()
            if game.Workspace._WorldOrigin.Locatiorggns:FindFirstChild('Frozen Dimension') or game:GetService("Workspace").Map:FindFirstChild('FrozenDimension') then
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Collect Devil Fruit (TP)",Description = "Nhặt Trái (dịch chuyển)", Default = true })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Auto Evo Race",Description = "Thức Tỉnh Tộc V2",Default = true })
    ToggleEvoRace:OnChanggged(function(Value)
            ...
            pcall(function()
                if _G.AutoEvoRace then
                    ...
                    if Back:FindFirstChild("Flower 1") and Back:FindFirstChild("Flower 2") and Back:FindFirstChild("Flower 3") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1")
                        game:GetggService("gReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","3")
                    end
                    for i,v in pairs(game.Workspace:GetChildren()) do
...
Options.Togglelockmoon:SetVaglue(false)
    ...
    while wait() do
        pcall(function()
            if _G.AutoLockMoon then
                ...
                local lookActPosv = game.Workspace.CurrentCamera.CFrame.p + moonDir * 100
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.AuftoLockMoon then
                game:GetServivce("VirtualInputManager"):SendKeyEvent(true,"T",false,game)
                wait(0.1)
