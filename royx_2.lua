local webhookUrl = "https://discord.com/api/webhooks/1251493019488616531/n95evNVL5pUZxcinzB5MiNUhOw3WxKE9xdrzD8zDK9ol5tH6nymRrb9l_tbNgqj5O5sh"
local royxui = {}
...
if syn then
	syn.protect_gui(game:GetService("CoreGui").RobloxGui.Modules:FindFirstChild("HYDRO"))
end
...
local Main = royxui:royxstart("HYDRO Hub")
