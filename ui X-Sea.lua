...
local MainDirectory = "X-Sea UI"
local AssetsDirectory = "X-Sea UI\\Assets"
...
if par:FindFirstChild('XSeaII') then
	par:FindFirstChild('XSeaII'):Destroy()
end

local XSeaII = Instance.new("ScreenGui")
XSeaII.Name = "XSeaII"
XSeaII.Parent = par
XSeaII.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function library.Create(options)
	local Shadown = Instance.new("ImageLabel")
	Shadown.Name = "Shadown"
	Shadown.Parent = XSeaII
