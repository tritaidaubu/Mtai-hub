...
DeveloperAccesText.Text = "Dev Is Tài sỉu"
...
Fries("<Color=Red>Thanks for using our script x-sea<Color=/>")
wait(0.01)
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16273390142";
      Title = "x-sea Hub", 
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16273390142"
...
ImageButton1.Image = "rbxassetid://16273390142" -- ảnh button ở ngoài --
...
-- để hình to to trước ui
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://16273390142"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16273390142"
...
Dis:AddSeperator("Discord")
   ...
   Dis:AddLabel("Discord X-sea Hub")

Dis:AddButton("X-sea", function()
setclipboard("https://discord.com/invite/ayjtxeUG") 
end)

Dis:AddLabel("Discord Partner")
Dis:AddButton("Box Khang Mod Game", function()
setclipboard("https://zalo.me/g/qxkjnw433") 
end)

Dis:AddButton("Chat chung", function()
setclipboard("https://zalo.me/g/xkxkru115") 
end)

Dis:AddSeperator("Hỗ Trợ")

Dis:AddLabel("Hỗ trợ cho PC/Mobile")
Dis:AddLabel("SCRIPT X-sea HUB UPDATE")
...
spawn(function()
    ...
    Main:AddToggle("Fast Attack [ SUPER OP ]",true,function(value)
       _G.HyperSonic = value
    end)      
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "rbxassetid://16273390142"..tostring(logo)
...
DiscordLib:Notification("." , "." , 10 ,15032052108 )
			else
...
DiscordLib:Notification("Thông Báo" , "Đã tăng nhân phẩm lên 9999999999999% fake" , 10 ,15032052108 )
    end)
...
spawn(function()
    ...
    spawn(function()
        ...
        D:AddToggle("Bring All Fruit 75% dễ reset đấy stop dùng này nha Kick System",_G.BringFruitBF,function(value)
...
D:AddSeperator("ESP MENU")
    ...
    D:AddToggle("ESP Player",true,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    ...
    D:AddToggle("ESP Fruit",true,function(a)
        DevilFruitESP = a
    ...
    D:AddToggle("ESP Flower",true,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
D:AddToggle("ESP Island",IslandESP,function(value)
    ...
    D:AddToggle("Esp Npc", true, function(nec)
    NpcESP = nec
end)
...
D:AddToggle("Esp Mob", true, function(nec)
    MobESP = nec
end)
end
...
Troll:AddButton("X-sea Hub",function()
...
Troll:AddButton("X-sea Hub! Bành Trướng Lãnh Địa",function()
...
Misc:AddButton("Kaitun Cap", function(value)
    ...
    Misc:AddButton("erase Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
spawn(function()
    ...
    WebhookurlFM = "https://discord.com/api/webhooks/1251514205652123769/oFeCXn_Q1L6XCBIRRuiApHuOGuDZMs2VForU9rbdEpIZwYJKlxF2UD3-HdK15ANZZiT9"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
    Webhookdao = "https://discord.com/api/webhooks/1251514205652123769/oFeCXn_Q1L6XCBIRRuiApHuOGuDZMs2VForU9rbdEpIZwYJKlxF2UD3-HdK15ANZZiT9"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or  game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
    WebhookElite = "https://discord.com/api/webhooks/1251514205652123769/oFeCXn_Q1L6XCBIRRuiApHuOGuDZMs2VForU9rbdEpIZwYJKlxF2UD3-HdK15ANZZiT9"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Cursed Captain") then
    WebhookBoss = "https://discord.com/api/webhooks/1251514205652123769/oFeCXn_Q1L6XCBIRRuiApHuOGuDZMs2VForU9rbdEpIZwYJKlxF2UD3-HdK15ANZZiT9"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
